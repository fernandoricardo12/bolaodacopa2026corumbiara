...
-- Recalcula o jogo atual para zerar os payouts indevidos
SELECT public.recalculate_individual_payouts_for_match(id)
FROM public.matches
WHERE is_friendly = true AND finished = true;